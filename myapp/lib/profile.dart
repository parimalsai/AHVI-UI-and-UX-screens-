...
class ProfileLensCameraTheme {
  final Color scrim;
  final Color controlPanel;
  final Color frameBorder;
  final Color frameGlow;
  ...
  factory ProfileLensCameraTheme.fromTokens(AppThemeTokens t) {
    return ProfileLensCameraTheme(
      scrim: t.backgroundPrimary.withValues(alpha: 0.56),
      controlPanel: t.phoneShellInner.withValues(alpha: 0.78),
      frameBorder: t.accent.primary.withValues(alpha: 0.92),
      frameGlow: t.accent.secondary.withValues(alpha: 0.30),
      primaryAction: t.accent.primary,
      secondaryAction: t.accent.tertiary,
      textPrimary: t.textPrimary,
      textMuted: t.mutedText,
      chipBg: t.panel.withValues(alpha: 0.88),
      chipBorder: t.panelBorder.withValues(alpha: 0.95),
    );
  }
}
